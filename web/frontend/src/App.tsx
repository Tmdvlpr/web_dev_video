...
function SideLabel({ children }: { children: React.ReactNode }) {
  return (
    <p className="px-3 pt-1 pb-1.5 text-[10px] font-bold tracking-widest uppercase select-none"
    ...
    <div className="h-screen flex flex-col" style={{ background: "var(--bg)" }}>
      ...
      <header className="flex items-center justify-between px-5 shrink-0 relative"
        ...
        <div className="flex items-center gap-2.5">
          ...
          <span style={{ fontFamily: "Manrope, sans-serif", fontWeight: 800, fontSize: 26, lineHeight: 1, letterSpacing: "0.08em", textTransform: "uppercase" }}>
